...
const sections = [
  ...
  },
  {
    ...
    hasButton: true, // Nueva propiedad para indicar que este texto tiene botón
    buttonText: "Únete a nosotros", // Texto del botón
    buttonLink: "https://forms.gle/7T1JkY4Y3q1DeQSk6", // Enlace del botón - puedes cambiarlo por la URL deseada
  },
];
        ...
        <div key={index} className="grid-item">
          {section.type === "text" ? (
            <div className="text-content">
              ...
              <p>{section.text}</p>
              {section.hasButton && (
                <a href={section.buttonLink} className="action-button">
                  {section.buttonText}
                </a>
              )}
            </div>
